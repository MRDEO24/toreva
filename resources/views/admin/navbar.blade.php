...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/admin">
                ...
                <div class="sidebar-brand-text mx-3">Toreva</div>
            </a>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item {{ $nama_halaman == 'Dashboard' ? 'active' : '' }}">
                <a class="nav-link" href="/admin">
                    <i class="fas fa-fw fa-home"></i>
                    <span>Dashboard</span></a>
            </li>
            <li class="nav-item {{ $nama_halaman == 'List Paket' ? 'active' : '' }}">
                <a class="nav-link" href="/admin/list">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>List Paket</span></a>
            </li>
            <li class="nav-item {{ $nama_halaman == 'List Order' ? 'active' : '' }}">
                <a class="nav-link" href="/admin/order">
                    <i class="fas fa-fw fa-luggage-cart"></i>
                    <span>List Orderan</span></a>
            </li>
            <li class="nav-item {{ $nama_halaman == 'Register Admin' ? 'active' : '' }}">
    ...
    <script>
        ...
        $('#OpenImgUpload2').click(function() {
            $('.kurayami2').trigger('click');
        });
        $('#OpenImgUpload3').click(function() {
            $('.kurayami3').trigger('click');
        });
        ...
        function EditpreviewImage(id) {
            document.getElementById("edit-image-preview" + id).style.display = "block";
            var oFReader = new FileReader();
            oFReader.readAsDataURL(document.getElementById("image-source" + id).files[0]);

            oFReader.onload = function(oFREvent) {
                document.getElementById("edit-image-preview" + id).src = oFREvent.target.result;
            };
        };
    </script>
